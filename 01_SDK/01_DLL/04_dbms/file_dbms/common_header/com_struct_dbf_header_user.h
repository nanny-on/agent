...
#ifndef DBF_STRUCT_DBF_HEADER_USER_H_4D39CDDB_E289_4d56_9F98_FE42776F4467
#define DBF_STRUCT_DBF_HEADER_USER_H_4D39CDDB_E289_4d56_9F98_FE42776F4467
...
typedef	INT32 (*ASIDBF_InitType)(PASIDBF_INIT_INFO pasidbf_init_info);
typedef	INT32 (*ASIDBF_CreateType)(PVOID* lpObject);
typedef	INT32 (*ASIDBF_FreeType)(PVOID* lpObject);

typedef INT32 (*ASIDBF_SetOpTickCntLogType)(PVOID lpObject, UINT32 nChkOpTickCnt);
typedef INT32 (*ASIDBF_SetASyncModeType)(PVOID lpObject, UINT32 nMode);
...
typedef INT32 (*ASIDBF_ModifyDBF_TableInitAutoIncrementType)(PVOID lpObject, LPCTSTR lpTableName, UINT64 nInitValue);
...
typedef INT32 (*ASIDBF_GetTbItemPriKeyFPType)(PVOID lpObject, LPCTSTR lpTableName, LPCTSTR lpTableColName, UINT64 nPriKey, LPCTSTR lpPriKey, PUINT64 pnFP);
typedef INT32 (*ASIDBF_GetTbItemPriKeyFPListType)(PVOID lpObject, LPCTSTR lpTableName, LPCTSTR lpTableColName, UINT64 nChkValueS, UINT64 nChkValueE, LPCTSTR lpChkValueS, LPCTSTR lpChkValueE, UINT32 nCompType, PUINT64* ppnFPList, PUINT32 pnFPListSize);
typedef INT32 (*ASIDBF_FreeTbItemPriKeyFPListType)(PVOID lpObject, PUINT64* ppnFPList);
...
#endif //DBF_STRUCT_DBF_HEADER_USER_H_4D39CDDB_E289_4d56_9F98_FE42776F4467
