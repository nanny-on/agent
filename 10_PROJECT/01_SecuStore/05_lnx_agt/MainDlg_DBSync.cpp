...
INT32		CMainDlg::SyncDatabase()
{
...

	{
		...
		tQueryList.push_back("CREATE TABLE local_env_doc_del_sch (id BIGINT AUTO_INCREMENT PRIMARY KEY, used_flag BIGINT DEFAULT 1, reg_date BIGINT DEFAULT 0, evt_time BIGINT DEFAULT 0, descr TEXT, used_mode BIGINT DEFAULT 0, ext_option BIGINT DEFAULT 0, del_path TEXT, sch_time BIGINT DEFAULT 0, scan_time BIGINT DEFAULT 0);");
	...
	//20210105 add jhjung
	{
		...
		tQueryList.push_back("CREATE TABLE po_in_ptn_ex_pkg (id BIGINT AUTO_INCREMENT PRIMARY KEY, used_flag BIGINT DEFAULT 1, reg_date BIGINT DEFAULT 0, name TEXT, descr TEXT, admin_id BIGINT DEFAULT 0, sub_admin_lock BIGINT DEFAULT 0, policy_id BIGINT DEFAULT 0, unit_id BIGINT DEFAULT 0, target_os BIGINT DEFAULT 0, ext_option BIGINT DEFAULT 0, used_mode BIGINT DEFAULT 0, chk_order BIGINT DEFAULT 0);");
		tQueryList.push_back("CREATE TABLE po_in_ptn_ex_unit (id BIGINT AUTO_INCREMENT PRIMARY KEY, used_flag BIGINT DEFAULT 1, reg_date BIGINT DEFAULT 0, seq_no BIGINT DEFAULT 0, name TEXT, descr TEXT, admin_id BIGINT DEFAULT 0, sub_admin_lock BIGINT DEFAULT 0, target_lock BIGINT DEFAULT 0, target_os BIGINT DEFAULT 0, ext_option BIGINT DEFAULT 0, used_mode BIGINT DEFAULT 0, block_mode BIGINT DEFAULT 0, unit_type BIGINT DEFAULT 0, flt_chk_type BIGINT DEFAULT 0, user_name TEXT, file_path TEXT, file_comp TEXT, file_desc TEXT, file_hash TEXT, file_sign_pub_name TEXT, file_sign_pub_sn TEXT, file_sign_cnt_name TEXT, file_sign_cnt_sn TEXT);");
		...
		tQueryList.push_back("CREATE TABLE po_nc_ptn_op (id BIGINT AUTO_INCREMENT PRIMARY KEY, used_flag BIGINT DEFAULT 1, reg_date BIGINT DEFAULT 0, seq_no BIGINT DEFAULT 0, name TEXT, descr TEXT, admin_id BIGINT DEFAULT 0, sub_admin_lock BIGINT DEFAULT 0, target_lock BIGINT DEFAULT 0, target_os BIGINT DEFAULT 0, ext_option BIGINT DEFAULT 0, used_mode BIGINT DEFAULT 0, block_mode BIGINT DEFAULT 0, kill_mode BIGINT DEFAULT 0, rt_fg_mode BIGINT DEFAULT 0);");
		tQueryList.push_back("CREATE TABLE po_nc_ptn_op_pkg (id BIGINT AUTO_INCREMENT PRIMARY KEY, used_flag BIGINT DEFAULT 1, reg_date BIGINT DEFAULT 0, name TEXT, descr TEXT, admin_id BIGINT DEFAULT 0, sub_admin_lock BIGINT DEFAULT 0, policy_id BIGINT DEFAULT 0, unit_id BIGINT DEFAULT 0, target_os BIGINT DEFAULT 0, ext_option BIGINT DEFAULT 0, used_mode BIGINT DEFAULT 0);");
		tQueryList.push_back("CREATE TABLE po_nc_ptn_op_unit (id BIGINT AUTO_INCREMENT PRIMARY KEY, used_flag BIGINT DEFAULT 1, reg_date BIGINT DEFAULT 0, seq_no BIGINT DEFAULT 0, name TEXT, descr TEXT, admin_id BIGINT DEFAULT 0, sub_admin_lock BIGINT DEFAULT 0, target_lock BIGINT DEFAULT 0, target_os BIGINT DEFAULT 0, ext_option BIGINT DEFAULT 0, used_mode BIGINT DEFAULT 0, sch_time TEXT, last_scan_time BIGINT DEFAULT 0, scan_path TEXT, file_gather_type BIGINT DEFAULT 0);");
		tQueryList.push_back("CREATE TABLE po_nc_ptn_lo (id BIGINT AUTO_INCREMENT PRIMARY KEY, used_flag BIGINT DEFAULT 1, reg_date BIGINT DEFAULT 0, seq_no BIGINT DEFAULT 0, name TEXT, descr TEXT, admin_id BIGINT DEFAULT 0, sub_admin_lock BIGINT DEFAULT 0, target_lock BIGINT DEFAULT 0, target_os BIGINT DEFAULT 0, ext_option BIGINT DEFAULT 0, used_mode BIGINT DEFAULT 0, ptn_range_type BIGINT DEFAULT 0, ptn_obj_type BIGINT DEFAULT 0, user_edit_ptn BIGINT DEFAULT 0, save_path TEXT, save_name TEXT, file_hash TEXT, ptn_version TEXT, ptn_unit_num BIGINT DEFAULT 0, ptn_chk_value BIGINT DEFAULT 0);");
		tQueryList.push_back("CREATE TABLE po_nc_ptn_bl (id BIGINT AUTO_INCREMENT PRIMARY KEY, used_flag BIGINT DEFAULT 1, reg_date BIGINT DEFAULT 0, seq_no BIGINT DEFAULT 0, name TEXT, descr TEXT, admin_id BIGINT DEFAULT 0, sub_admin_lock BIGINT DEFAULT 0, target_lock BIGINT DEFAULT 0, target_os BIGINT DEFAULT 0, ext_option BIGINT DEFAULT 0, used_mode BIGINT DEFAULT 0, save_path TEXT, save_name TEXT, file_hash TEXT, ptn_version TEXT, ptn_unit_num BIGINT DEFAULT 0, ptn_chk_value BIGINT DEFAULT 0);");
		tQueryList.push_back("CREATE TABLE po_nc_ptn_bl_pkg (id BIGINT AUTO_INCREMENT PRIMARY KEY, used_flag BIGINT DEFAULT 1, reg_date BIGINT DEFAULT 0, name TEXT, descr TEXT, admin_id BIGINT DEFAULT 0, sub_admin_lock BIGINT DEFAULT 0, policy_id BIGINT DEFAULT 0, unit_id BIGINT DEFAULT 0, target_os BIGINT DEFAULT 0, ext_option BIGINT DEFAULT 0, used_mode BIGINT DEFAULT 0);");
		tQueryList.push_back("CREATE TABLE po_nc_ptn_bl_unit (id BIGINT AUTO_INCREMENT PRIMARY KEY, used_flag BIGINT DEFAULT 1, reg_date BIGINT DEFAULT 0, seq_no BIGINT DEFAULT 0, name TEXT, descr TEXT, admin_id BIGINT DEFAULT 0, sub_admin_lock BIGINT DEFAULT 0, target_lock BIGINT DEFAULT 0, target_os BIGINT DEFAULT 0, ext_option BIGINT DEFAULT 0, used_mode BIGINT DEFAULT 0, rt_mode BIGINT DEFAULT 0, flt_chk_type BIGINT DEFAULT 0, file_name TEXT, file_path TEXT, file_comp TEXT, file_desc TEXT, file_hash TEXT, file_sign_pub_name TEXT, file_sign_pub_sn TEXT, file_sign_cnt_name TEXT, file_sign_cnt_sn TEXT);");
		tQueryList.push_back("CREATE TABLE po_nc_ptn_wl (id BIGINT AUTO_INCREMENT PRIMARY KEY, used_flag BIGINT DEFAULT 1, reg_date BIGINT DEFAULT 0, seq_no BIGINT DEFAULT 0, name TEXT, descr TEXT, admin_id BIGINT DEFAULT 0, sub_admin_lock BIGINT DEFAULT 0, target_lock BIGINT DEFAULT 0, target_os BIGINT DEFAULT 0, ext_option BIGINT DEFAULT 0, used_mode BIGINT DEFAULT 0, save_path TEXT, save_name TEXT, file_hash TEXT, ptn_version TEXT, ptn_unit_num BIGINT DEFAULT 0, ptn_chk_value BIGINT DEFAULT 0);");
		tQueryList.push_back("CREATE TABLE po_nc_ptn_wl_pkg (id BIGINT AUTO_INCREMENT PRIMARY KEY, used_flag BIGINT DEFAULT 1, reg_date BIGINT DEFAULT 0, name TEXT, descr TEXT, admin_id BIGINT DEFAULT 0, sub_admin_lock BIGINT DEFAULT 0, policy_id BIGINT DEFAULT 0, unit_id BIGINT DEFAULT 0, target_os BIGINT DEFAULT 0, ext_option BIGINT DEFAULT 0, used_mode BIGINT DEFAULT 0);");
		tQueryList.push_back("CREATE TABLE po_nc_ptn_wl_unit (id BIGINT AUTO_INCREMENT PRIMARY KEY, used_flag BIGINT DEFAULT 1, reg_date BIGINT DEFAULT 0, seq_no BIGINT DEFAULT 0, name TEXT, descr TEXT, admin_id BIGINT DEFAULT 0, sub_admin_lock BIGINT DEFAULT 0, target_lock BIGINT DEFAULT 0, target_os BIGINT DEFAULT 0, ext_option BIGINT DEFAULT 0, used_mode BIGINT DEFAULT 0, rt_mode BIGINT DEFAULT 0, flt_chk_type BIGINT DEFAULT 0, file_name TEXT, file_path TEXT, file_comp TEXT, file_desc TEXT, file_hash TEXT, file_sign_pub_name TEXT, file_sign_pub_sn TEXT, file_sign_cnt_name TEXT, file_sign_cnt_sn TEXT);");
		tQueryList.push_back("CREATE TABLE po_nc_ptn_ex (id BIGINT AUTO_INCREMENT PRIMARY KEY, used_flag BIGINT DEFAULT 1, reg_date BIGINT DEFAULT 0, seq_no BIGINT DEFAULT 0, name TEXT, descr TEXT, admin_id BIGINT DEFAULT 0, sub_admin_lock BIGINT DEFAULT 0, target_lock BIGINT DEFAULT 0, target_os BIGINT DEFAULT 0, ext_option BIGINT DEFAULT 0, used_mode BIGINT DEFAULT 0);");
		tQueryList.push_back("CREATE TABLE po_nc_ptn_ex_pkg (id BIGINT AUTO_INCREMENT PRIMARY KEY, used_flag BIGINT DEFAULT 1, reg_date BIGINT DEFAULT 0, name TEXT, descr TEXT, admin_id BIGINT DEFAULT 0, sub_admin_lock BIGINT DEFAULT 0, policy_id BIGINT DEFAULT 0, unit_id BIGINT DEFAULT 0, target_os BIGINT DEFAULT 0, ext_option BIGINT DEFAULT 0, used_mode BIGINT DEFAULT 0, chk_order BIGINT DEFAULT 0);");
		tQueryList.push_back("CREATE TABLE po_nc_ptn_ex_unit (id BIGINT AUTO_INCREMENT PRIMARY KEY, used_flag BIGINT DEFAULT 1, reg_date BIGINT DEFAULT 0, seq_no BIGINT DEFAULT 0, name TEXT, descr TEXT, admin_id BIGINT DEFAULT 0, sub_admin_lock BIGINT DEFAULT 0, target_lock BIGINT DEFAULT 0, target_os BIGINT DEFAULT 0, ext_option BIGINT DEFAULT 0, used_mode BIGINT DEFAULT 0, block_mode BIGINT DEFAULT 0, unit_type BIGINT DEFAULT 0, flt_chk_type BIGINT DEFAULT 0, user_name TEXT, file_path TEXT, file_comp TEXT, file_desc TEXT, file_hash TEXT, file_sign_pub_name TEXT, file_sign_pub_sn TEXT, file_sign_cnt_name TEXT, file_sign_cnt_sn TEXT);");
		tQueryList.push_back("CREATE TABLE po_nc_ptn_sp (id BIGINT AUTO_INCREMENT PRIMARY KEY, used_flag BIGINT DEFAULT 1, reg_date BIGINT DEFAULT 0, seq_no BIGINT DEFAULT 0, name TEXT, descr TEXT, admin_id BIGINT DEFAULT 0, sub_admin_lock BIGINT DEFAULT 0, target_lock BIGINT DEFAULT 0, target_os BIGINT DEFAULT 0, ext_option BIGINT DEFAULT 0, used_mode BIGINT DEFAULT 0, confirm_level BIGINT DEFAULT 0, confirm_day BIGINT DEFAULT 0);");
		tQueryList.push_back("CREATE TABLE po_nc_ptn_sp_unit (id BIGINT AUTO_INCREMENT PRIMARY KEY, used_flag BIGINT DEFAULT 1, reg_date BIGINT DEFAULT 0, seq_no BIGINT DEFAULT 0, name TEXT, descr TEXT, admin_id BIGINT DEFAULT 0, sub_admin_lock BIGINT DEFAULT 0, target_lock BIGINT DEFAULT 0, target_os BIGINT DEFAULT 0, ext_option BIGINT DEFAULT 0, used_mode BIGINT DEFAULT 0, block_mode BIGINT DEFAULT 0, confirm_info BIGINT DEFAULT 0, flt_chk_type BIGINT DEFAULT 0, file_name TEXT, file_path TEXT, file_comp TEXT, file_desc TEXT, file_hash TEXT, file_sign_pub_name TEXT, file_sign_pub_sn TEXT, file_sign_cnt_name TEXT, file_sign_cnt_sn TEXT);");
		tQueryList.push_back("CREATE TABLE po_nc_ptn_no (id BIGINT AUTO_INCREMENT PRIMARY KEY, used_flag BIGINT DEFAULT 1, reg_date BIGINT DEFAULT 0, seq_no BIGINT DEFAULT 0, name TEXT, descr TEXT, admin_id BIGINT DEFAULT 0, sub_admin_lock BIGINT DEFAULT 0, target_lock BIGINT DEFAULT 0, target_os BIGINT DEFAULT 0, ext_option BIGINT DEFAULT 0, used_mode BIGINT DEFAULT 0, msg_type BIGINT DEFAULT 0, req_skip_opt BIGINT DEFAULT 0);");
		tQueryList.push_back("CREATE TABLE po_nc_ptn_no_pkg (id BIGINT AUTO_INCREMENT PRIMARY KEY, used_flag BIGINT DEFAULT 1, reg_date BIGINT DEFAULT 0, name TEXT, descr TEXT, admin_id BIGINT DEFAULT 0, sub_admin_lock BIGINT DEFAULT 0, policy_id BIGINT DEFAULT 0, unit_id BIGINT DEFAULT 0, target_os BIGINT DEFAULT 0, ext_option BIGINT DEFAULT 0, used_mode BIGINT DEFAULT 0);");
		tQueryList.push_back("CREATE TABLE po_in_ptn_sp_pkg (id BIGINT AUTO_INCREMENT PRIMARY KEY, used_flag BIGINT DEFAULT 1, reg_date BIGINT DEFAULT 0, name TEXT, descr TEXT, admin_id BIGINT DEFAULT 0, sub_admin_lock BIGINT DEFAULT 0, policy_id BIGINT DEFAULT 0, unit_id BIGINT DEFAULT 0, target_os BIGINT DEFAULT 0, ext_option BIGINT DEFAULT 0, used_mode BIGINT DEFAULT 0, chk_order BIGINT DEFAULT 0);");
		tQueryList.push_back("CREATE TABLE po_nc_ptn_sp_pkg (id BIGINT AUTO_INCREMENT PRIMARY KEY, used_flag BIGINT DEFAULT 1, reg_date BIGINT DEFAULT 0, name TEXT, descr TEXT, admin_id BIGINT DEFAULT 0, sub_admin_lock BIGINT DEFAULT 0, policy_id BIGINT DEFAULT 0, unit_id BIGINT DEFAULT 0, target_os BIGINT DEFAULT 0, ext_option BIGINT DEFAULT 0, used_mode BIGINT DEFAULT 0, chk_order BIGINT DEFAULT 0);");
		tQueryList.push_back("CREATE TABLE po_in_ptn_sp_rule (id BIGINT AUTO_INCREMENT PRIMARY KEY, used_flag BIGINT DEFAULT 1, reg_date BIGINT DEFAULT 0, seq_no BIGINT DEFAULT 0, name TEXT, descr TEXT, admin_id BIGINT DEFAULT 0, sub_admin_lock BIGINT DEFAULT 0, target_lock BIGINT DEFAULT 0, target_os BIGINT DEFAULT 0, ext_option BIGINT DEFAULT 0, used_mode BIGINT DEFAULT 0, target_type BIGINT DEFAULT 0, target_id BIGINT DEFAULT 0, file_id BIGINT DEFAULT 0, req_level BIGINT DEFAULT 0, req_day BIGINT DEFAULT 0, confirm_type BIGINT DEFAULT 0, confirm_id BIGINT DEFAULT 0, confirm_rst BIGINT DEFAULT 0, use_day BIGINT DEFAULT 0, file_key TEXT, file_path TEXT, file_name TEXT, evt_date BIGINT DEFAULT 0, end_date BIGINT DEFAULT 0);");
		tQueryList.push_back("CREATE TABLE po_nc_ptn_sp_rule (id BIGINT AUTO_INCREMENT PRIMARY KEY, used_flag BIGINT DEFAULT 1, reg_date BIGINT DEFAULT 0, seq_no BIGINT DEFAULT 0, name TEXT, descr TEXT, admin_id BIGINT DEFAULT 0, sub_admin_lock BIGINT DEFAULT 0, target_lock BIGINT DEFAULT 0, target_os BIGINT DEFAULT 0, ext_option BIGINT DEFAULT 0, used_mode BIGINT DEFAULT 0, target_type BIGINT DEFAULT 0, target_id BIGINT DEFAULT 0, file_id BIGINT DEFAULT 0, req_level BIGINT DEFAULT 0, req_day BIGINT DEFAULT 0, confirm_type BIGINT DEFAULT 0, confirm_id BIGINT DEFAULT 0, confirm_rst BIGINT DEFAULT 0, use_day BIGINT DEFAULT 0, file_key TEXT, file_path TEXT, file_name TEXT, evt_date BIGINT DEFAULT 0, end_date BIGINT DEFAULT 0);");
		tQueryList.push_back("CREATE TABLE po_host_web_sock (id BIGINT AUTO_INCREMENT PRIMARY KEY, used_flag BIGINT DEFAULT 1, reg_date BIGINT DEFAULT 0, seq_no BIGINT DEFAULT 0, name TEXT, descr TEXT, admin_id BIGINT DEFAULT 0, sub_admin_lock BIGINT DEFAULT 0, target_lock BIGINT DEFAULT 0, target_os BIGINT DEFAULT 0, ext_option BIGINT DEFAULT 0, used_mode BIGINT DEFAULT 0, svr_port BIGINT DEFAULT 0, web_key TEXT, policy_type TEXT, policy_opt TEXT);");
		tQueryList.push_back("CREATE TABLE po_in_ptn_op (id BIGINT AUTO_INCREMENT PRIMARY KEY, used_flag BIGINT DEFAULT 1, reg_date BIGINT DEFAULT 0, seq_no BIGINT DEFAULT 0, name TEXT, descr TEXT, admin_id BIGINT DEFAULT 0, sub_admin_lock BIGINT DEFAULT 0, target_lock BIGINT DEFAULT 0, target_os BIGINT DEFAULT 0, ext_option BIGINT DEFAULT 0, used_mode BIGINT DEFAULT 0, block_mode BIGINT DEFAULT 0, kill_mode BIGINT DEFAULT 0, rt_fg_mode BIGINT DEFAULT 0);");
		tQueryList.push_back("CREATE TABLE po_nc_ptn_ex_trust (id BIGINT AUTO_INCREMENT PRIMARY KEY, used_flag BIGINT DEFAULT 1, reg_date BIGINT DEFAULT 0, seq_no BIGINT DEFAULT 0, name TEXT, descr TEXT, admin_id BIGINT DEFAULT 0, sub_admin_lock BIGINT DEFAULT 0, target_lock BIGINT DEFAULT 0, target_os BIGINT DEFAULT 0, ext_option BIGINT DEFAULT 0, used_mode BIGINT DEFAULT 0, policy_id BIGINT DEFAULT 0, unit_id BIGINT DEFAULT 0, block_mode BIGINT DEFAULT 0, sf_name TEXT, of_name TEXT, file_key TEXT);");
		tQueryList.push_back("CREATE TABLE po_in_ptn_ex_trust (id BIGINT AUTO_INCREMENT PRIMARY KEY, used_flag BIGINT DEFAULT 1, reg_date BIGINT DEFAULT 0, seq_no BIGINT DEFAULT 0, name TEXT, descr TEXT, admin_id BIGINT DEFAULT 0, sub_admin_lock BIGINT DEFAULT 0, target_lock BIGINT DEFAULT 0, target_os BIGINT DEFAULT 0, ext_option BIGINT DEFAULT 0, used_mode BIGINT DEFAULT 0, policy_id BIGINT DEFAULT 0, unit_id BIGINT DEFAULT 0, block_mode BIGINT DEFAULT 0, sf_name TEXT, of_name TEXT, file_key TEXT);");
...

	{
		...
		tQueryList.push_back("CREATE TABLE site_file_alias (id BIGINT AUTO_INCREMENT PRIMARY KEY, used_flag BIGINT DEFAULT 1, reg_date BIGINT DEFAULT 0, used_mode BIGINT DEFAULT 0, reg_svr_id BIGINT DEFAULT 1, sync_svr_step BIGINT DEFAULT 0, confirm_status BIGINT DEFAULT 0, fe_key TEXT, file_path TEXT, file_name TEXT);");
...

	{
		...
		tQueryList.push_back("CREATE TABLE po_in_ptn_sp_pkg (id BIGINT AUTO_INCREMENT PRIMARY KEY, used_flag BIGINT DEFAULT 1, reg_date BIGINT DEFAULT 0, name TEXT, descr TEXT, admin_id BIGINT DEFAULT 0, sub_admin_lock BIGINT DEFAULT 0, policy_id BIGINT DEFAULT 0, unit_id BIGINT DEFAULT 0, notify_info_id BIGINT DEFAULT 0, ext_option BIGINT DEFAULT 0, used_mode BIGINT DEFAULT 0, chk_order BIGINT DEFAULT 0);");
		tQueryList.push_back("CREATE TABLE po_nc_ptn_sp_pkg (id BIGINT AUTO_INCREMENT PRIMARY KEY, used_flag BIGINT DEFAULT 1, reg_date BIGINT DEFAULT 0, name TEXT, descr TEXT, admin_id BIGINT DEFAULT 0, sub_admin_lock BIGINT DEFAULT 0, policy_id BIGINT DEFAULT 0, unit_id BIGINT DEFAULT 0, notify_info_id BIGINT DEFAULT 0, ext_option BIGINT DEFAULT 0, used_mode BIGINT DEFAULT 0, chk_order BIGINT DEFAULT 0);");
	...
	
	{
		...
		tQueryList.push_back("CREATE TABLE po_nc_ptn_op (id BIGINT AUTO_INCREMENT PRIMARY KEY, used_flag BIGINT DEFAULT 1, reg_date BIGINT DEFAULT 0, seq_no BIGINT DEFAULT 0, name TEXT, descr TEXT, admin_id BIGINT DEFAULT 0, sub_admin_lock BIGINT DEFAULT 0, target_lock BIGINT DEFAULT 0, notify_info_id BIGINT DEFAULT 0, ext_option BIGINT DEFAULT 0, used_mode BIGINT DEFAULT 0, block_mode BIGINT DEFAULT 0, kill_mode BIGINT DEFAULT 0, rt_fg_mode BIGINT DEFAULT 0);");
		tQueryList.push_back("CREATE TABLE po_nc_ptn_op_pkg (id BIGINT AUTO_INCREMENT PRIMARY KEY, used_flag BIGINT DEFAULT 1, reg_date BIGINT DEFAULT 0, name TEXT, descr TEXT, admin_id BIGINT DEFAULT 0, sub_admin_lock BIGINT DEFAULT 0, policy_id BIGINT DEFAULT 0, unit_id BIGINT DEFAULT 0, notify_info_id BIGINT DEFAULT 0, ext_option BIGINT DEFAULT 0, used_mode BIGINT DEFAULT 0);");
		...
		tQueryList.push_back("CREATE TABLE po_nc_ptn_bl_pkg (id BIGINT AUTO_INCREMENT PRIMARY KEY, used_flag BIGINT DEFAULT 1, reg_date BIGINT DEFAULT 0, name TEXT, descr TEXT, admin_id BIGINT DEFAULT 0, sub_admin_lock BIGINT DEFAULT 0, policy_id BIGINT DEFAULT 0, unit_id BIGINT DEFAULT 0, notify_info_id BIGINT DEFAULT 0, ext_option BIGINT DEFAULT 0, used_mode BIGINT DEFAULT 0);");
		...
		tQueryList.push_back("CREATE TABLE po_nc_ptn_wl (id BIGINT AUTO_INCREMENT PRIMARY KEY, used_flag BIGINT DEFAULT 1, reg_date BIGINT DEFAULT 0, seq_no BIGINT DEFAULT 0, name TEXT, descr TEXT, admin_id BIGINT DEFAULT 0, sub_admin_lock BIGINT DEFAULT 0, target_lock BIGINT DEFAULT 0, notify_info_id BIGINT DEFAULT 0, ext_option BIGINT DEFAULT 0, used_mode BIGINT DEFAULT 0, save_path TEXT, save_name TEXT, file_hash TEXT, ptn_version TEXT, ptn_unit_num BIGINT DEFAULT 0, ptn_chk_value BIGINT DEFAULT 0);");
		tQueryList.push_back("CREATE TABLE po_nc_ptn_wl_pkg (id BIGINT AUTO_INCREMENT PRIMARY KEY, used_flag BIGINT DEFAULT 1, reg_date BIGINT DEFAULT 0, name TEXT, descr TEXT, admin_id BIGINT DEFAULT 0, sub_admin_lock BIGINT DEFAULT 0, policy_id BIGINT DEFAULT 0, unit_id BIGINT DEFAULT 0, notify_info_id BIGINT DEFAULT 0, ext_option BIGINT DEFAULT 0, used_mode BIGINT DEFAULT 0);");
		tQueryList.push_back("CREATE TABLE po_nc_ptn_wl_unit (id BIGINT AUTO_INCREMENT PRIMARY KEY, used_flag BIGINT DEFAULT 1, reg_date BIGINT DEFAULT 0, seq_no BIGINT DEFAULT 0, name TEXT, descr TEXT, admin_id BIGINT DEFAULT 0, sub_admin_lock BIGINT DEFAULT 0, target_lock BIGINT DEFAULT 0, notify_info_id BIGINT DEFAULT 0, ext_option BIGINT DEFAULT 0, used_mode BIGINT DEFAULT 0, rt_mode BIGINT DEFAULT 0, flt_chk_type BIGINT DEFAULT 0, file_name TEXT, file_path TEXT, file_comp TEXT, file_desc TEXT, file_hash TEXT, file_sign_pub_name TEXT, file_sign_pub_sn TEXT, file_sign_cnt_name TEXT, file_sign_cnt_sn TEXT);");
		...
		tQueryList.push_back("CREATE TABLE po_nc_ptn_ex_pkg (id BIGINT AUTO_INCREMENT PRIMARY KEY, used_flag BIGINT DEFAULT 1, reg_date BIGINT DEFAULT 0, name TEXT, descr TEXT, admin_id BIGINT DEFAULT 0, sub_admin_lock BIGINT DEFAULT 0, policy_id BIGINT DEFAULT 0, unit_id BIGINT DEFAULT 0, notify_info_id BIGINT DEFAULT 0, ext_option BIGINT DEFAULT 0, used_mode BIGINT DEFAULT 0, chk_order BIGINT DEFAULT 0);");
		tQueryList.push_back("CREATE TABLE po_nc_ptn_ex_trust (id BIGINT AUTO_INCREMENT PRIMARY KEY, used_flag BIGINT DEFAULT 1, reg_date BIGINT DEFAULT 0, seq_no BIGINT DEFAULT 0, name TEXT, descr TEXT, admin_id BIGINT DEFAULT 0, sub_admin_lock BIGINT DEFAULT 0, target_lock BIGINT DEFAULT 0, notify_info_id BIGINT DEFAULT 0, ext_option BIGINT DEFAULT 0, used_mode BIGINT DEFAULT 0, policy_id BIGINT DEFAULT 0, unit_id BIGINT DEFAULT 0, block_mode BIGINT DEFAULT 0, sf_name TEXT, of_name TEXT, file_key TEXT);");
		...
		tQueryList.push_back("CREATE TABLE po_nc_ptn_sp_pkg (id BIGINT AUTO_INCREMENT PRIMARY KEY, used_flag BIGINT DEFAULT 1, reg_date BIGINT DEFAULT 0, name TEXT, descr TEXT, admin_id BIGINT DEFAULT 0, sub_admin_lock BIGINT DEFAULT 0, policy_id BIGINT DEFAULT 0, unit_id BIGINT DEFAULT 0, notify_info_id BIGINT DEFAULT 0, ext_option BIGINT DEFAULT 0, used_mode BIGINT DEFAULT 0);");
		...
		tQueryList.push_back("CREATE TABLE po_nc_ptn_no_pkg (id BIGINT AUTO_INCREMENT PRIMARY KEY, used_flag BIGINT DEFAULT 1, reg_date BIGINT DEFAULT 0, name TEXT, descr TEXT, admin_id BIGINT DEFAULT 0, sub_admin_lock BIGINT DEFAULT 0, policy_id BIGINT DEFAULT 0, unit_id BIGINT DEFAULT 0, notify_info_id BIGINT DEFAULT 0, ext_option BIGINT DEFAULT 0, used_mode BIGINT DEFAULT 0);");
		...
		tQueryList.push_back("CREATE TABLE host_status_po_nc (id BIGINT AUTO_INCREMENT PRIMARY KEY, used_flag BIGINT DEFAULT 1, host_id BIGINT DEFAULT 0, work_mode TEXT, ptn_ver TEXT);");
	...
	{
		TListStr tQueryList;
		tQueryList.push_back("CREATE TABLE info_proc_reputation (id BIGINT AUTO_INCREMENT PRIMARY KEY, edit_date BIGINT DEFAULT 0, site_file_id BIGINT DEFAULT 0, reputation BIGINT DEFAULT 0, num_of_user BIGINT DEFAULT 0);");
		...
		tQueryList.push_back("DROP TABLE po_in_ptn_ex_pkg;");
		tQueryList.push_back("CREATE TABLE po_in_ptn_ex_pkg (id BIGINT AUTO_INCREMENT PRIMARY KEY, used_flag BIGINT DEFAULT 1, reg_date BIGINT DEFAULT 0, name TEXT, descr TEXT, admin_id BIGINT DEFAULT 0, sub_admin_lock BIGINT DEFAULT 0, policy_id BIGINT DEFAULT 0, unit_id BIGINT DEFAULT 0, notify_info_id BIGINT DEFAULT 0, ext_option BIGINT DEFAULT 0, used_mode BIGINT DEFAULT 0, chk_order BIGINT DEFAULT 0);");
		tQueryList.push_back("DROP TABLE po_in_ptn_ex_unit;");
		tQueryList.push_back("CREATE TABLE po_in_ptn_ex_unit (id BIGINT AUTO_INCREMENT PRIMARY KEY, used_flag BIGINT DEFAULT 1, reg_date BIGINT DEFAULT 0, seq_no BIGINT DEFAULT 0, name TEXT, descr TEXT, admin_id BIGINT DEFAULT 0, sub_admin_lock BIGINT DEFAULT 0, target_lock BIGINT DEFAULT 0, notify_info_id BIGINT DEFAULT 0, ext_option BIGINT DEFAULT 0, used_mode BIGINT DEFAULT 0, block_mode BIGINT DEFAULT 0, unit_type BIGINT DEFAULT 0, flt_chk_type BIGINT DEFAULT 0, user_name TEXT, file_path TEXT, file_comp TEXT, file_desc TEXT, file_hash TEXT, file_sign_pub_name TEXT, file_sign_pub_sn TEXT, file_sign_cnt_name TEXT, file_sign_cnt_sn TEXT);");
