...
#ifndef LogicMgrLogDeviceH
#define LogicMgrLogDeviceH
//---------------------------------------------------------------------------

class CLogicMgrLogDevice	: public CLogicBase
{
private:
...
public:
	void		SetLogDevice(DB_LOG_DEVICE& dls);
...
extern CLogicMgrLogDevice*		t_LogicMgrLogDevice;
