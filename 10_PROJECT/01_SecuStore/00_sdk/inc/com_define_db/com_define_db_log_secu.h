...
#define SS_LOG_SECU_BLOCK_BIT_TYPE_DENY					0x00000010 // 
#define SS_LOG_SECU_BLOCK_BIT_TYPE_ALLOW				0x00000020 // 
#define SS_LOG_SECU_BLOCK_BIT_TYPE_WARN					0x00000040 // 
#define SS_LOG_SECU_BLOCK_BIT_TYPE_HIDE					0x00000080 // 
#define SS_LOG_SECU_BLOCK_BIT_TYPE_KILL					0x00000100 // 

#define SS_LOG_SECU_BLOCK_BIT_TYPE_W_DENY				(SS_LOG_SECU_BLOCK_BIT_TYPE_DENY|SS_LOG_SECU_BLOCK_BIT_TYPE_WARN) // 
#define SS_LOG_SECU_BLOCK_BIT_TYPE_W_ALLOW				(SS_LOG_SECU_BLOCK_BIT_TYPE_ALLOW|SS_LOG_SECU_BLOCK_BIT_TYPE_WARN) // 
#define SS_LOG_SECU_BLOCK_BIT_TYPE_W_KILL				(SS_LOG_SECU_BLOCK_BIT_TYPE_KILL|SS_LOG_SECU_BLOCK_BIT_TYPE_WARN) // 
...
#define		SS_LOG_SECU_OP_TYPE_FILE_EXT_RENAME_SRC		0x10
#define		SS_LOG_SECU_OP_TYPE_FILE_EXT_RENAME_DST		0x11
